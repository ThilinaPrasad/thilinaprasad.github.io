...
**Cut+Dry Inc.** | United States (Mar 2026 - Present)

<u>Skills: Java · Spring · PHP · AWS · PostgreSQL · React · Docker</u><br/>

Key contributions,<br/>
- Engineered a Low-Code Integration Hub platform utilising Spring, React, PostgreSQL, AWS ECS, SQS and S3, reducing customer ERP data ingestion time from 3-5 days to ~1 day for the Cut+Dry platform.
- Mentored junior engineers and led code reviews across a 5-engineer team.

## Senior Software Engineer
**Cut+Dry Inc.** | United States (Mar 2025 - Mar 2026)

Key contributions,<br/>
- Architected and implemented 15+ production-critical REST APIs in adherence to Spring, JPA and PostgreSQL standards within the Integration Hub Manager microservice.
- Architected an annotation-based framework utilizing Spring and Redis for ERP-specific configuration management, reducing frontend overhead per integration and cutting end-to-end ERP integration time from ~5 to ~3 days.

## Team Lead
**Enactor Ltd.** (Aug 2023 - Feb 2025)
...
- Worked with set of well experienced industrial and academic personalities to share our knowledge and experience to guide participants of 'NASA Space Apps Colombo 2020' event to implement their challenges(projects).
